...
class BackAppRPi:
    def __init__(self):
        ...
        self.servo_obj_list = [0, Angles(servo_pin=12), 0]
        self.us_obj_list = [0, Measure(trig=23, echo=24), 0]
    ...
    def orient(self):
        while True:
            ...
            print(f"Angle to be applied on Servo : {self.angle_list[1]}")
            self.servo_obj_list[1].set_angle(self.angle_list[1])
            self.dist_list[1] = self.us_obj_list[1].distance_read()
